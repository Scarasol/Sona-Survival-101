                ...
                context.get().enqueueWork(() -> {
                    if (context.get().getDirection().getReceptionSide().isServer()){
                        ...
                        if (player != null){
                            ...
                            if (blockEntity instanceof IBaseContainerBlockEntityAccessor baseContainerBlockEntity && !blockEntity.getTileData().contains("flag")){
                                if (msg.isLocked())
                                    baseContainerBlockEntity.lockContainer(blockEntity.getTileData(), msg.getLockCode());
                                blockEntity.getTileData().putBoolean("flag", true);
