    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        ...
        if (entity.isInWaterRainOrBubble()){
            if (burnUnderWater){
                ...
                if (entity.getLevel() instanceof ServerLevel server && ignitedTime % 10 == 0){
            ...
            if (burnUnderWater){
                breakPowderSnow(entity.getLevel(), new BlockPos(entity.getX(), entity.getY(), entity.getZ()));
                breakPowderSnow(entity.getLevel(), new BlockPos(entity.getX(), entity.getY() + 1, entity.getZ()));
            } else{
        ...
        if (ignitedTime % 20 == 0){
            entity.hurt(DamageSource.IN_FIRE, amplifier + 1);
        }
    }
